...
export declare function normalizeCodeLanguage(lang: string): string;
...
export declare function tokenizeDiffHighlight(tokens: (string | Token)[], language: string): (string | Token)[];
